...
func procEvents(mm ...string) (dd []*eventsDef, err error) {
	...
	const (
		importTypePathTpl = "github.com/madnikulin50/lowcode/server/%s/types"
		importAutoPathTpl = "github.com/madnikulin50/lowcode/server/%s/automation"
		importAuthPath    = "github.com/madnikulin50/lowcode/server/pkg/auth"
	)
