#!/usr/bin/env bash
# Copy PostgreSQL database localhost/test11 → 161.104.90.77/db_ru5
# Replaces public schema on the destination (destructive).
#
# Usage:
#   LOCAL_PGPASSWORD=... REMOTE_PGPASSWORD=... ./scripts/migrate-test11-to-db_ru5.sh
#
