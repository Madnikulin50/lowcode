<template>
  ...
  >
    ...
    <div class="toolbar d-flex flex-column h-100 border-end shadow-lg flex-shrink-0">
      <div
        id="toolbar"
        ref="toolbar"
    ...
    <div
      class="card flex-grow-1 h-100 border-0 shadow-sm rounded-0"
      style="min-width: 0"
    >
    ...
    >
      ...
      <div class="offcanvas-footer bg-white border-top border-light p-1">
        <div class="d-flex m-2">
          ...
          <div id="sidebar-footer" class="ms-auto"></div>
        </div>
      </div>
    </div>
