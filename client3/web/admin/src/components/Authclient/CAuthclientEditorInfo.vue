  ...
  <div class="card shadow-sm auth-clients" data-test-id="card-auth-client-info" v-if="resource">
    ...
    <form @submit.prevent="submit">
      <div class="row">
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3">
            ...
            <small v-if="resource.isDefault" class="form-text text-muted">{{ $t('handle.disabledFootnote') }}</small>
          </div>
        </div>

        <div class="col-12">
          <div class="mb-3">
            <label class="form-label text-primary">{{ $t('redirectURI') }}</label>
          ...
          <div v-if="!fresh" class="mb-3">
            <label class="form-label text-primary d-flex align-items-center gap-1">
              ...
              <button
                ...
                :title="$t('tooltip.show-client-secret')"
                @click="showSecret()"
              >
              ...
              <button
                ...
                :title="$t('tooltip.hide-client-secret')"
                @click="hideSecret()"
              >
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3">
            <div class="form-check">
              ...
              >
              <label class="form-check-label" for="scope-profile">{{ $t('profile') }}</label>
            </div>
            <div class="form-check">
              <input
                id="scope-api"
              ...
              >
              <label class="form-check-label" for="scope-api">{{ $t('api') }}</label>
            </div>
            <div class="form-check">
              <input
                id="scope-openid"
              ...
              >
              <label class="form-check-label" for="scope-openid">{{ $t('openid') }}</label>
            </div>
            <div v-if="discoveryEnabled" class="form-check">
              ...
              >
              <label class="form-check-label" for="scope-discovery">{{ $t('discovery') }}</label>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="valid-from">
            <label class="form-label text-primary">{{ $t('validFrom.label') }}</label>
            <small class="form-text text-muted">{{ $t('validFrom.description') }}</small>
            <c-input-date-time
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="expires-at">
            <label class="form-label text-primary">{{ $t('expiresAt.label') }}</label>
            <small class="form-text text-muted">{{ $t('expiresAt.description') }}</small>
            <c-input-date-time
          ...
          <div class="mb-3">
            <div class="form-check">
              <input
                ...
                :disabled="resource.isDefault"
              >
              <label class="form-check-label" for="checkbox-enabled">{{ $t('enabled.label') }}</label>
            </div>
            <small v-if="resource.isDefault" class="form-text text-muted">{{ $t('enabled.disabledFootnote') }}</small>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3">
            ...
            <small class="form-text text-muted">{{ $t('trusted.description') }}</small>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div v-show="isClientCredentialsGrant" class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="impersonate-user">
            <label class="form-label text-primary">{{ $t('security.impersonateUser.label') }}</label>
            <small class="form-text text-muted">{{ $t('security.impersonateUser.description') }}</small>
            <c-input-user
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="permitted-roles">
            <label class="form-label text-primary">{{ $t('security.permittedRoles.label') }}</label>
            <c-role-picker v-model="resource.security.permittedRoles">
              <template #description>{{ $t('security.permittedRoles.description') }}</template>
            </c-role-picker>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="prohibited-roles">
            <label class="form-label text-primary">{{ $t('security.prohibitedRoles.label') }}</label>
            <c-role-picker v-model="resource.security.prohibitedRoles">
              <template #description>{{ $t('security.prohibitedRoles.description') }}</template>
            </c-role-picker>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="mb-3" data-test-id="forced-roles">
            <label class="form-label text-primary">{{ $t('security.forcedRoles.label') }}</label>
            <c-role-picker v-model="resource.security.forcedRoles" class="mb-3">
              <template #description>{{ $t('security.forcedRoles.description') }}</template>
            </c-role-picker>
          </div>
        </div>
          ...
          <div class="mb-3">
            <label class="form-label text-primary d-flex align-items-center gap-1">
              ...
              <button
                ...
                :title="$t('tooltip.copy-access-token')"
      ...
      <div class="row">
        <div class="col-12 col-lg-6">
          <div class="mb-3">
            <label class="form-label text-primary">{{ $t('security.defaultUserGroup.label') }}</label>
            <c-input-user-group
