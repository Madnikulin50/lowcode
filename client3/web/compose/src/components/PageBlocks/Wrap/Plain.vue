<template>
  <div class="h-100">
    ...
    >
      <div
        v-if="showHeader"
        class="card-header border-bottom bg-transparent text-nowrap ps-3 pe-2"
          ...
          >
            ...
            >
              <button
                ...
                class="btn btn-outline-extra-light d-print-none text-secondary px-2 py-1 border-0"
                title="Refresh"
      ...
      <div
        class="card-body p-0 flex-fill position-relative"
