...
Агенты — отдельные процессы рядом с платформой. Пространство Compose (namespace) — продукт; агент — вычислительный контур, который нельзя удобно выразить low-code блоками.
